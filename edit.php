...
<body class="profile-page">
  ...
  <a class="v194_24"  href="#" style="text-decoration:none;">AAS</a>
  <a class="button v194_25" href="#" style="text-decoration:none;">الملف الشخصي</a>
  <span class="v194_26">نظام</span>
  <span class="v194_27">للإرشاد الأكاديمي بكلية الحاسب</span>
  <a class="button v194_28 " href="FAQ.html" style="text-decoration:none;">الاسالة الشائعة</a>
  <button class="button v194_29">الانذارات</button>
  <a class="button v194_30" href="ST.html" style="text-decoration:none;">اقتراحات لتدريب الصيفي</a>
  <a class="button v194_31" href="levels.html" style="text-decoration:none;">وصف المقررات</a>
  <button class="button v194_33">
  <span>ارسال ايميل </span>
  </button>
  <a  class="button v194_32" href="www/index.php" style="text-decoration:none;text-align: center; font-size: 50px;"><span>حجز موعد</span></a>
  <a class="button v194_34"href="computer.html" style="text-decoration:none; font-size: 50px;"> دليلك للحاسب </a>
